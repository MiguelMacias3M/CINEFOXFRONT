  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity
          style={styles.adminButton}
          onPress={() => handleNavigation('ContactoMsj')}>
          <Text style={styles.buttonText}>Mensajes de contacto</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.adminButton}
          onPress={() => handleNavigation('SalaManagement')}>
          <Text style={styles.buttonText}>Gestión de Salas</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.adminButton}
